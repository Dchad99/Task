...
public final class ItemQueryParser {
    ...
    /**
     * The single home of the listing defaults: {@code null} means the client did
     * not send the parameter, and is replaced by {@link #DEFAULT_PAGE},
     * {@link #DEFAULT_PAGE_SIZE} or the default sort.
     */
    public static Pageable toPageable(Integer requestedPage, Integer requestedSize, String sort) {
