...
public class ItemController {
     ...
     *
     * <p>Parameters are validated in one place ({@link ItemQueryParser}) rather than
     * via Spring Data's {@code Pageable} argument resolver, so the rules are
     * explicit, unit-testable, and produce our own error shape.
     */
    @GetMapping
